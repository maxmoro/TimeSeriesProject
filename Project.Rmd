...
author: "Max Moro and Shan Weinstock"
output:
  html_document:
    df_print: paged
    toc: true
...
The Parzen Window shows peaks at frequencies 0.17 and 0.34 (~6 and ~3 months). We can see there is also potential peak at 0.08 (12 months)
...
The PACF shows signals of AR(3), but there is an erratic patern up to AR(9), we can't be sure there is a pure AR model. The  sample autocorrelation shows cycling pattern extending above the value of 0.5, so we should not have an MA only model
